...
Begin
    CreateModalForm('Инструкция', '1. Нажмите 1 кнопку или Ins для добавления.'#13#10'2. Нажмите 2 кнопку или Del для удаления.'#13#10'3. Для подсчёта уровней, на которых имеются листья'#13#10' только у одного потомка, нажмите 3 кнопку.'#13#10'4. Максимальная глубина дерева 7.'#13#10'5. Диапазон значений узла [1..999].', 600, 250);
End;
