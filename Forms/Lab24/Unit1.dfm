object MainForm: TMainForm
  ...
  Caption = '351005 '#1043#1072#1083#1091#1093#1072' '#1055#1072#1074#1077#1083' Lab24'
  ClientHeight = 612
  ClientWidth = 570
  Color = clBtnFace
  ...
  object TaskLabel: TLabel
    ...
    Height = 69
    Caption = 
      #1044#1072#1085#1085#1072#1103' '#1087#1088#1086#1075#1088#1072#1084#1084#1072' '#1087#1086#1076#1089#1095#1080#1090#1099#1074#1072#1077#1090' '#1095#1080#1089#1083#1086' '#1087#1086#1074#1090#1086#1088#1103#1102#1097#1080#1093#1089#1103' '#1095#1080#1089#1077#1083' '#1084#1072#1090#1088#1080#1094#1099' ' +
      'A '#1087#1086#1088#1103#1076#1082#1072' n.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -17
    Font.Name = 'Segoe UI'
