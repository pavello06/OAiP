...
begin
    InstructionLabel.Caption := '1. Число n должно быть натуральным,'#13#10' а числа массива - целыми.'#13#10'2. Число n лежит в диапазоне[1; 100].'#13#10'3. Числa массива лежат в диапазоне[-1000; 1000].';
