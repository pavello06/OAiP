...
begin
    InstructionLabel.Caption := '1. Число n и числа массива должны быть натуральными.'#13#10'2. Число n лежит в диапазоне[1; 99].'#13#10'3. Числa массива лежат в диапазоне[1; 9999].';
