...
begin
    InstructionLabel.Caption := '1. Значения a, b, c, x0, xn, h рациональные.'#13#10'2. Значения a, b, c, x0, xn принадлежат диапазону[-1000; 1000].'#13#10'3. Значение xn должно быть больше x0.'#13#10'4. Значение h  положительное в диапазоне(0; 1000].'#13#10'5. Файл должен иметь 6 строк с этими значениями.';
