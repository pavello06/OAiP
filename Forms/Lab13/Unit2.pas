...
begin
    InstructionLabel.Caption := '1. Число EPS должно лежать в диапазоне(0; 1].'#13#10'2. Число X должно лежать в диапазоне[-1000; 1000].'#13#10'3. Файл должен содержать: 1 строку с EPS, 2 строку с Х.';
